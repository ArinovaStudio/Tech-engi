...
const testimonials = [
  ...
  },
  {
    name: "Baisakhi",
    role: "User",
    image: "/users/image copy 2.png",
    text: "Client ke perspective se bolun toh yeh platform engineers aur clients ko connect karne ke liye really great hai. Workflow kaafi smooth hai, support bhi excellent hai, aur overall experience bilkul hassle-free aur reliable laga.",
  },
  {
    name: "Sarah Khan",
    role: "Engineer",
    image: "/users/image copy.png",
    text: "From an engineer’s perspective, this platform makes it really easy to connect with clients. The workflow is smooth, tasks are clear, and the support team is responsive whenever needed. Overall, it’s been an efficient and reliable experience.",
  },
];
