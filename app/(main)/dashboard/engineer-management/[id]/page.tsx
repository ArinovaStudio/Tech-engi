...
import { Users, Calendar, TrendingUp, BarChart3, Mail, Building2, Award, BadgeDollarSignIcon, LucideLoader } from "lucide-react";
import dynamic from 'next/dynamic';
import AdminPayoutManagement from "@/components/admin/payout/AdminPayoutManagement";
    ...
    <div className="space-y-6">
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2 text-blue-100 justify-center md:justify-start">
                <Award size={16} />
                <span className="px-3 py-1 bg-white/20 rounded-full text-sm font-medium">{user.role.name || "Employee"}</span>
              </div>
            </div>
          </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-1 inline-flex gap-1">
        ...
        <button
          ...
          className={`flex items-center gap-2 px-6 py-2.5 rounded-md font-medium transition-all ${activeTab === 'account'
            ? 'bg-blue-600 text-white shadow-md'
            : 'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700'
            }`}
        >
      ...
      {activeTab === 'projects' ? (
        ...
        <AdminPayoutManagement userId={user.id} userName={user.name} />
      ) : (
        <div>
