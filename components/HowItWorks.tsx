        ...
        <div
          ...
          {steps.map((step, index) => {
            ...
            return (
              <div
                key={index}
                className=" relative w-full max-w-[390px] mx-auto font-id">
                {/* ORANGE BACKGROUND */}
                <div
                  className=" absolute left-[-16px] right-[-16px] sm:left-[-20px] sm:right-[-20px] top-[140px] h-[220px] rounded-3xl bg-[#FFAE58] z-0"/>
                ...
                <div
                  ...
                  <div className="mt-8 sm:mt-10 flex justify-center">
                    <div className="relative border-4 border-gray-200 dark:border-slate-800 rounded-2xl">
                      ...
                      {/* GLOW */}
                      <div
                        className=" absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-24 h-24 bg-gradient-to-b from-[#FFB05F] to-[#FF8400] rounded-2xl blur-lg opacity-40"/>

                      {/* ICON BOX */}
                      <div
                        className=" relative w-20 h-20 bg-gradient-to-b from-[#FFB05F] to-[#FF8400] rounded-2xl flex items-center justify-center">
                        <Icon
                          size={40}
