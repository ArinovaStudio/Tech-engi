  ...
  return (
    ...
    "
            ...
            <div className="flex items-center gap-3 px-2 mt-6 lg:justify-end">
              ...
              <Button size="sm" className="bg-[var(--primary)] hover:bg-[var(--primary-light)] hover:text-[var(--text-secondary)] cursor-pointer" onClick={handleSave}>
                Save Changes
              </Button>
            </div>
          </form>
          ...
          <form className="flex flex-col">
            ...
            <div className="flex items-center gap-3 px-2 mt-6 lg:justify-end">
              ...
              <button
                ...
                className={`text-center bg-[var(--primary)] px-4 py-2.5 text-white rounded-lg hover:bg-[var(--primary-light)] ${(loading || !oldPassword) ? "opacity-50 cursor-not-allowed" : "opacity-100 cursor-pointer"}`}
