        ...
        <div className="relative w-full p-4 overflow-y-auto rounded-3xl bg-white dark:bg-gray-900 lg:p-11">
          ...
          <form className="flex flex-col">
            ...
            <div className="flex items-center gap-3 px-2 mt-6 lg:justify-end">
              ...
              <button
                className={`text-center bg-[var(--primary)] px-4 py-2.5 text-white rounded-lg hover:bg-[var(--primary-light)] hover:text-[var(--text-primary)]`}
